  ...
  return (
    <div className="w-full space-y-8">
      {categories.map((category) => {
        ...
        // safe fallback image for category
        const categoryImage = category.products?.[0]?.images?.[0] || "/images/default-category.png";
            ...
            >
              <div className="flex flex-col gap-6">
                {category.products.map((product, productIndex) => {
                  ...
                  const productImage = product.images?.[0] || categoryImage;
