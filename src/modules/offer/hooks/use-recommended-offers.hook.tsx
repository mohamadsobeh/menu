...
import { useRecommendedOffersData } from '../services';

export interface UseRecommendedOffersParams {
    initialPage?: number;
    initialLimit?: number;
}
...
export const useRecommendedOffers = ({
    ...
    const {
        ...
        isFetching,
        refetch,
    } = useRecommendedOffersData({ page: currentPage, limit });
    ...
    const errorMessage = useMemo(() => {
        ...
        return 'An unknown error occurred while fetching recommended offers';
    }, [isError, error]);
